...
*/			
	...
	/**
	 * This method is used to upload file of any type
	 * @param buttonID- This is the element ID 
	 * @param subDirectoryPath- This is the path of the sub directory
	 * @param fileName- This is the name of the file to be uploaded
	 * @throws Exception
	 */
	public void fileUpload(String buttonID, String subDirectoryPath, String fileName) throws Exception{
		try{
			WebElement webElement = elementController.waitForWebElement(BrowserDriver.getBrowserDriver(),null, false, "BrowseButton");
			webElement.click();
		    Robot robot = new Robot();
		    robot.setAutoDelay(2000);
		    StringSelection ss = new StringSelection(testDataController.baseDirPath + "\\"+ subDirectoryPath + "\\" + fileName);
			...
			throw new Exception("Unable to select file to upload [selectFileToUpload()]: " + exception.getMessage());
		}
	}
}